...
class Property(models.Model):
    ...
    image1 = models.ImageField(upload_to='property_photos/',null=True)
    image2 = models.ImageField(upload_to='property_photos/',null=True)
    image3 = models.ImageField(upload_to='property_photos/',null=True)
    image4 = models.ImageField(upload_to='property_photos/',null=True)
    image5 = models.ImageField(upload_to='property_photos/',null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
